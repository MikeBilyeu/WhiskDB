...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <br />
      <p>
        It is ZipiWhisk's policy to respect your privacy regarding any
        information we may collect while operating our website. This Privacy
        Policy applies to{" "}
        <a href="http://www.zipiwhisk.com">www.zipiwhisk.com</a> (hereinafter,
        "us", "we", or "www.zipiwhisk.com"). We respect your privacy and are
      ...
      <p>
        Like most website operators, ZipiWhisk collects
        ...
        request. ZipiWhisk's purpose in collecting non-personally identifying
        information is to better understand how ZipiWhisk's visitors use its
        website. From time to time, ZipiWhisk may release
        non-personally-identifying information in the aggregate, e.g., by
        publishing a report on trends in the usage of its website.
      </p>
      <p>
        ZipiWhisk also collects potentially personally-identifying information
        like Internet Protocol (IP) addresses for logged in users and for users
        leaving comments on http://www.zipiwhisk.com blog posts. ZipiWhisk only
      ...
      <p>
        Certain visitors to ZipiWhisk's websites choose to interact with
        ZipiWhisk in ways that require ZipiWhisk to gather
        personally-identifying information. The amount and type of information
        that ZipiWhisk gathers depends on the nature of the interaction. For
        example, we ask visitors who sign up for a blog at
        http://www.zipiwhisk.com to provide a username and email address.
      </p>
      <h2>Security</h2>
      <p>
      ...
      <p>
        ...
        Privacy Policy covers the use of cookies by ZipiWhisk and does not cover
      ...
      <p>
        ZipiWhisk may collect statistics about the behavior of visitors to its
        website. ZipiWhisk may display this information publicly or provide it
        to others. However, ZipiWhisk does not disclose your
        personally-identifying information.
      </p>
      <h2>Cookies</h2>
      <p>
        To enrich and perfect your online experience, ZipiWhisk uses "Cookies",
      ...
      <p>
        ...
        time the visitor returns. ZipiWhisk uses cookies to help ZipiWhisk
        identify and track visitors, their usage of http://www.zipiwhisk.com,
        and their website access preferences. ZipiWhisk visitors who do not wish
        to have cookies placed on their computers should set their browsers to
        refuse cookies before using ZipiWhisk's websites, with the drawback that
        certain features of ZipiWhisk's websites may not function properly
        without the aid of cookies.
      </p>
      <p>
        By continuing to navigate our website without changing your cookie
        settings, you hereby acknowledge and agree to ZipiWhisk's use of
        cookies.
      </p>
      <h2>Privacy Policy Changes</h2>
      <p>
        Although most changes are likely to be minor, ZipiWhisk may change its
        Privacy Policy from time to time, and in ZipiWhisk's sole discretion.
        ZipiWhisk encourages visitors to frequently check this page for any
      ...
      <p>
        ...
        via <a href="mailto:zipiwhisk@gmail.com">email</a>
      </p>
    </>
  );
};
